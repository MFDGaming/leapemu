...
uint32_t arc_aux_reg_read_default(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return reg_map->regs[reg_id].val;
}

void arc_aux_reg_write_default(arc_aux_reg_map_t *reg_map, uint32_t reg_id, uint32_t reg_val) {
    reg_map->regs[reg_id].val = reg_val;
}

uint32_t arc_aux_reg_read_status(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
...
uint32_t arc_aux_reg_read_identity(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x0d010112;
}

uint32_t arc_aux_reg_read_vbfdw_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000000;
}

uint32_t arc_aux_reg_read_ext_arith_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000001;
}

uint32_t arc_aux_reg_read_dataspace(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000000a;
}

uint32_t arc_aux_reg_read_memsubsys(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000001;
}

uint32_t arc_aux_reg_read_vecbase_ac_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000001;
}

uint32_t arc_aux_reg_read_p_base_addr(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00fc0001;
}

uint32_t arc_aux_reg_read_d_cache_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00006201;
}

uint32_t arc_aux_reg_read_madi_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000000;
}

uint32_t arc_aux_reg_read_ldstram_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000000;
}

uint32_t arc_aux_reg_read_timer_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000302;
}

uint32_t arc_aux_reg_read_ap_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000000;
}

uint32_t arc_aux_reg_read_i_cache_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00016401;
}

uint32_t arc_aux_reg_read_addsub_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000000;
}

uint32_t arc_aux_reg_read_dspram_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00001203;
}

uint32_t arc_aux_reg_read_mac_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000203;
}

uint32_t arc_aux_reg_read_multiply_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000001;
}

uint32_t arc_aux_reg_read_swap_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000001;
}

uint32_t arc_aux_reg_read_norm_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000002;
}

uint32_t arc_aux_reg_read_minmax_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000000;
}

uint32_t arc_aux_reg_read_barrel_build(arc_aux_reg_map_t *reg_map, uint32_t reg_id) {
    return 0x00000002;
}
...
#define __SME(RI, R, W) ({ \
    ...
    __SME(ARC_REG_IC_IVIC, NULL, arc_aux_reg_write_default);
    ...
    __SME(ARC_REG_IC_LIL, NULL, arc_aux_reg_write_default);
    __SME(ARC_REG_IC_IVIL, NULL, arc_aux_reg_write_default);
    __SME(ARC_REG_IC_RAM_ADDR, arc_aux_reg_read_default, arc_aux_reg_write_default);
